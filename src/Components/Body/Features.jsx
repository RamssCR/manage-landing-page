...
const FeatureItem = ({ number, title, description }) => (
    <section className="flex flex-col sm:flex-row sm:items-start sm:gap-5 mb-8">
      <div className="flex items-center gap-4 sm:flex-col sm:items-start sm:gap-0">
        <span className="bg-orange-400 text-white px-6 py-2 rounded-full font-semibold mb-[30px] sm:mr-4">
          {number}
        </span>
      ...
      <div>
        ...
        <p className="md:max-w-[500px] max-w-auto text-gray-400 text-[20px] mb-8">
          {description}
        </p>
      </div>
    </section>
